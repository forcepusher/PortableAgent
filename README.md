...
Use this copypasta in the AGENTS.md file or a custom rule/system prompt. Works great for local LLMs.  
```
...
Tool usage rules:
1. NEVER use tools inside a think block. Close think then call tool.
